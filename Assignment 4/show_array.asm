...
;
;Purpose
;  This program outputs all the elements in an array given by the user.
;
;This file:
...
;  Prototype of this function: void show_array(double* array, int array_size);
;========1=========2=========3=========4=========5=========6=========7=========8=========9=========0=========1=========2=========3**
...
segment .data
    title db "IEEE54			Scientific Decimal", 10, 0
...
; Print our title to show the columns in our output
    mov rdi, title
    call printf
